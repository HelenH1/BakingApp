...
public class RecipeIngredientAdapter extends RecyclerView.Adapter<RecipeIngredientAdapter.IngredientViewHolder> {
     ...
     */
    public RecipeIngredientAdapter(@NonNull Context context, IngredientAdapterOnClickHandler clickHandler) {
        mContext = context;
     ...
     * passed into us.
     *
     * @param ingredientViewHolder The ViewHolder which should be updated to represent the
    ...
    public void onBindViewHolder(IngredientViewHolder ingredientViewHolder, int position) {
        ...
        //ingredientViewHolder.nameView.setText(name);
        //ingredientViewHolder.servings.setText(servings);
        String quantity = mIngredients.getAsString("quantity"+position);
        String measure = mIngredients.getAsString("measure"+position);
        String ingred = mIngredients.getAsString("ingredient"+position);


        ingredientViewHolder.measure.setText(measure);
        ingredientViewHolder.quantity.setText(quantity);
        ingredientViewHolder.ingredient.setText(ingred);
    ...
    public int getItemCount() {
        ...
        return mIngredients.getAsInteger("count");
    }
    ...
    class IngredientViewHolder extends RecyclerView.ViewHolder {
        ...
        IngredientViewHolder(View view) {
            ...
            measure = (TextView) view.findViewById(R.id.tv_measure);
        ...
        //    int adapterPosition = getAdapterPosition();
            ...
            //ContentValues weatherForDay = mBasicMovieInfo[adapterPosition];
    ...
    public void setBasicMovieInfo(ContentValues basicMovieData) {
        ...
        System.out.println("Is setBasicMovieInfo working?");
        mIngredients = basicMovieData;
