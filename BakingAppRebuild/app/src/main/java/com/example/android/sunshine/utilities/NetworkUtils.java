...
public final class NetworkUtils {
    ...
    public static URL getUrlForMainActivity() {
    ...
    public static URL getUrlForDetailActivity(String movie_key) {
        Uri weatherQueryUri = Uri.parse(URL).buildUpon()
                .build();
    ...
    public static Uri getUriForVideo(String vidurl) {
        Uri trailerUri = Uri.parse(vidurl).buildUpon()
                .build();
