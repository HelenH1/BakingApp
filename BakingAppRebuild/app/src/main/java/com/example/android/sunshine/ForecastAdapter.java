...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    private ContentValues[] mBasicMovieInfo;
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        forecastAdapterViewHolder.nameView.setText(name);
        forecastAdapterViewHolder.servings.setText(servings);
    ...
    class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ForecastAdapterViewHolder(View view) {
            super(view);
            nameView = (TextView) view.findViewById(R.id.tv_recipe_name);
            servings = (TextView) view.findViewById(R.id.tv_recipe_servings);
    ...
    public void setBasicMovieInfo(ContentValues[] basicMovieData) {
        mBasicMovieInfo = basicMovieData;
